(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new BindItem("item1","taCont","value","dsBoard","cont");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","edtWriter","value","dsBoard","writer");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","edtModifier","value","dsBoard","modifier");
            this.addChild(obj.name, obj);
            obj.bind();
