(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"200\"/><Column size=\"300\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"내용\"/><Cell col=\"3\" text=\"작성자\"/><Cell col=\"4\" text=\"등록일\"/></Band><Band id=\"body\"><Cell text=\"bind:boardNo\"/><Cell col=\"1\" text=\"bind:title\" edittype=\"text\"/><Cell col=\"2\" text=\"bind:cont\" edittype=\"text\"/><Cell col=\"3\" text=\"bind:writer\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:regDt\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
